...
const CreateBoardPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <h1 className="title-medium-14 mb-4">Create a New Board</h1>
      <form onSubmit={handleSubmit} className="w-full max-w-sm">
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow appearance-none border rounded-sm w-full py-2 px-3 title-medium-12 leading-tight focus:outline-none focus:shadow-outline"
            required
          />
        </div>
        <Button
